        ...
        if result_dict == '':
            ...
            for result in json.loads(result_dict):
                result_frame.append([
                    ...
                    self.deal_json('exDate', result),
                    self.deal_json('proportion', result),
                    self.deal_json('progress', result),
                    self.deal_json('actualRaise', result),
                    self.deal_json('dDate', result),
                    self.deal_json('registerDate', result),
                    self.deal_json('issueDate', result),
                    self.deal_json('announceDate', result),
                    self.deal_json('price', result),
                    self.deal_json('proportionalLimit', result),
                    self.deal_json('issueCode', result),
                    self.deal_json('name', result),
                    self.deal_json('year', result),
                    self.deal_json('saDate', result),
                    self.deal_json('sDate', result),
                    self.deal_json('raiseCeiling', result)
                ])
            return result_frame
