        ...
        if result_dict == '':
            ...
            for result in json.loads(result_dict):
                result_frame.append([
                    ...
                    self.deal_json('shareholderDate', result),
                    self.deal_json('acuxiDate', result),
                    self.deal_json('payment', result),
                    self.deal_json('implementationDate', result),
                    self.deal_json('asharesDate', result),
                    self.deal_json('boardDate', result),
                    self.deal_json('dividendRate', result),
