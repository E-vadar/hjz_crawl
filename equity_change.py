        ...
        if result_dict == '':
            ...
            for result in json.loads(result_dict):
                result_frame.append([
                    ...
                    self.deal_json('changeReason', result),
                    self.deal_json('changeDate', result),
                    self.deal_json('afterLimit', result),
                    self.deal_json('afterAll', result),
                    self.deal_json('afterNoLimit', result)
                ])
            return result_frame
