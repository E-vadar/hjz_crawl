        ...
        if result_dict == '':
            ...
            for result in json.loads(result_dict):
                result_frame.append([
                    ...
                    self.deal_json('grnt_ed', result),
                    self.deal_json('announcement_date', result),
                    self.deal_json('secured_org_gid', result),
                    self.deal_json('announcement_date', result),
                    self.deal_json('grnt_corp_name', result),
                    self.deal_json('is_fulfillment', result),
                    self.deal_json('currency_variety', result),
                    self.deal_json('showMonth', result),
                    self.deal_json('grnt_sd', result),
                    self.deal_json('is_related_trans', result),
                    self.deal_json('grnt_period', result),
                    self.deal_json('grnt_type', result),
                    self.deal_json('grnt_corp_gid', result),
                    self.deal_json('grnt_amt', result),
                    self.deal_json('secured_org_name', result),
                    self.deal_json('ed', result)
                ])
            return result_frame
