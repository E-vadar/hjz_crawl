...
class spiders(object):
    ...
    def parse_data(self, response, company_name, qyxx_id):
        ...
        if result_dict == '':
            ...
            pastStafferList = result_dict.get('pastStafferList')
            if pastLegalPersonList:
                for result in pastLegalPersonList:
                    result_frame.append([
                        ...
                        self.deal_json('time', result),
                        self.deal_json('name', result),
                    ])
            if pastholderList:
                for result in pastholderList:
                    result_frame.append([
                        response.get('data').get('noSqlId'),
                        qyxx_id,
                        company_name,
