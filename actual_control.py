...
class spiders(object):
    ...
    def parse_data(self, response, company_name, qyxx_id):
        ...
        if result_dict == '':
            ...
            # print("舆情有内容，开始格式化！")
            actualController = result_dict.get("actualController")
            if actualController:
                for result in actualController:
                    result_frame.append([
                        ...
                        self.deal_json('hId', result),
                        self.deal_json('gId', result),
